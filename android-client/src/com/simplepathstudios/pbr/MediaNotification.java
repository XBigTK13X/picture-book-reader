...
public class MediaNotification {
    public static final class Action {
        public static final String PLAY = "com.simplepathstudios.pbr.play";
        public static final String PAUSE = "com.simplepathstudios.pbr.pause";
        public static final String NEXT = "com.simplepathstudios.pbr.next";
        public static final String PREVIOUS = "com.simplepathstudios.pbr.previous";
        public static final String VIEW_NOW_PLAYING = "com.simplepathstudios.pbr.view-now-playing";
    }
    public static final Integer NOTIFICATION_ID = 776677;
    private static final String NOTIFICATION_NAME = "PBR";
    private static final String NOTIFICATION_CHANNEL_ID = "com.simplepathstudios.pbr";
    ...
    private MediaNotification(MainActivity mainActivity){
        String description = "PBR controls and information about playing media.";
        ...
        ObservableMusicQueue.getInstance().observe(new Observer<MusicQueue>() {
            ...
            public void onChanged(MusicQueue musicQueue) {
                if(musicQueue != null && musicQueue.currentIndex != null && PBRService.getInstance() != null && PBRService.getInstance().getMediaSession() != null){
                    MusicFile currentSong = musicQueue.getCurrent();
                    MediaSession.Token token = PBRService.getInstance().getMediaSession().getSessionToken();
                    ...
                    PBRService.getInstance().startForeground(NOTIFICATION_ID, notification);
